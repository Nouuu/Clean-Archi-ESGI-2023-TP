...
public class CliHelper {
    ...
    public void printHelpMessage() {
        ...
        this.writer.write("Examples :");
        this.writer.write("  add -c \"new task\" -d:2023-02-02 - Add a new todo with due date 2023-02-02");
        this.writer.write("  add -c \"sub task\" -p:1 - Add a new sub todo with parent task id 1");
        this.writer.write("  update 1 -c \"new content\" -d:2023-02-02 - Update a todo with new content and due date 2023-02-02");
    }
